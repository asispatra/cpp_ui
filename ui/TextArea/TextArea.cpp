...
TextArea :: TextArea(string label) {
	enable=true;
	xy=Point(1, 1);
	dim=Dimension(36, 1);
	label_width=10;
...
void TextArea :: setAllowedCharacters(string str){
	allowedChars=str;
}

string TextArea :: getAllowedCharacters(){
	return allowedChars;
}

void TextArea :: setSize(int n){
	size=n;
}
...
void TextArea :: setLabelWidth(unsigned short label_width) {
	this->label_width=label_width;
}

unsigned short TextArea :: getLabelWidth(void) {
	return label_width;
}

void TextArea :: setSeparator(string separator) {
	this->separator=separator;
}

string TextArea :: getSeparator(void) {
	return separator;
}
...
string TextArea :: getLabel(void) {
	return label;
}

void TextArea :: setValue(string value) {
	this->value=value;
}

string TextArea :: getValue(void) {
	return value;
}
...
void TextArea :: printTextInBox(int boxStartX, int boxWidth, int curPos, int indexPos) {
...
bool TextArea :: findInAllowedCharacters(char ch) {
	bool result=false;
